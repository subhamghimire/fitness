...
export class InitMigration1770131457415 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "exercises" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "images" text array, "title" character varying(150) NOT NULL, "slug" character varying(255) NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_c4c46f5fa89a58ba7c2d894e3c3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "workout_exercise_id" uuid NOT NULL, "order_index" integer NOT NULL DEFAULT '0', "weight" double precision, "reps" integer, "rpe" integer, "is_warmup" boolean NOT NULL DEFAULT false, "is_dropset" boolean NOT NULL DEFAULT false, "is_failure" boolean NOT NULL DEFAULT false, "duration_seconds" integer, "distance" double precision, CONSTRAINT "PK_5d15ed8b3e2a5cb6e9c9921d056" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_31a6f55b3ecb4516de1970f5c9" ON "sets" ("workout_exercise_id") `);
        await queryRunner.query(`CREATE TABLE "workout_exercises" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "workout_id" uuid NOT NULL, "exercise_id" uuid NOT NULL, "order_index" integer NOT NULL DEFAULT '0', "notes" text, "rest_seconds" integer, CONSTRAINT "PK_377f9ead6fd69b29f0d0feb1028" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7e6040e931b008308aaddbb7d3" ON "workout_exercises" ("workout_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_9a0656f321d9a96de2eb685e85" ON "workout_exercises" ("exercise_id") `);
        await queryRunner.query(`CREATE TABLE "workouts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "user_id" uuid NOT NULL, "name" character varying(150), "notes" text, "started_at" TIMESTAMP NOT NULL, "ended_at" TIMESTAMP, "duration_seconds" integer, CONSTRAINT "PK_5b2319bf64a674d40237dbb1697" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2df679279a7ac263bcff20c78d" ON "workouts" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "sets" ADD CONSTRAINT "FK_31a6f55b3ecb4516de1970f5c94" FOREIGN KEY ("workout_exercise_id") REFERENCES "workout_exercises"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "workout_exercises" ADD CONSTRAINT "FK_7e6040e931b008308aaddbb7d32" FOREIGN KEY ("workout_id") REFERENCES "workouts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "workout_exercises" ADD CONSTRAINT "FK_9a0656f321d9a96de2eb685e85a" FOREIGN KEY ("exercise_id") REFERENCES "exercises"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sets" DROP CONSTRAINT "FK_31a6f55b3ecb4516de1970f5c94"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2df679279a7ac263bcff20c78d"`);
        await queryRunner.query(`DROP TABLE "workouts"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9a0656f321d9a96de2eb685e85"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7e6040e931b008308aaddbb7d3"`);
        await queryRunner.query(`DROP TABLE "workout_exercises"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_31a6f55b3ecb4516de1970f5c9"`);
