...
export class SyncController {
  ...
  syncBatch(@Body() dto: SyncBatchRequestDto, @CurrentUser() user: User) {
    return this.syncService.syncBatch(dto, user);
  }

  /** @deprecated Legacy full-tree workout push */
  @Post("workouts")
  @HttpCode(HttpStatus.OK)
  syncWorkout(@Body() dto: SyncWorkoutDto, @CurrentUser() user: User) {
