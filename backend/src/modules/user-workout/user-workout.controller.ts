...
export class UserWorkoutController {
  ...
  create(@Req() req: any, @Body() createDto: CreateUserWorkoutDto): Promise<UserWorkoutResponseDto> {
  ...
  findAll(@Req() req: any, @Query() query: UserWorkoutQueryDto): Promise<PaginatedUserWorkoutResponseDto> {
  ...
  findOne(@Req() req: any, @Param("id", ParseUUIDPipe) id: string): Promise<UserWorkoutResponseDto> {
  ...
  @ApiResponse({ status: 404, description: "Not found" })
  update(@Req() req: any, @Param("id", ParseUUIDPipe) id: string, @Body() updateDto: UpdateUserWorkoutDto): Promise<UserWorkoutResponseDto> {
